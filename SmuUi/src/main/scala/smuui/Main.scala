...
//    currentAdcCalibration = Some(device.Calibration(slope = -136.9675985f, intercept = 2042.29232f)),
//    currentSinkDacCalibration = Some(device.Calibration(slope = 137.5259337f, intercept = 2048.703187f)),
  )
